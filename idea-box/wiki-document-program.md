...
1. 버전 관리
   ...
   - 동시 수정하기 이전에 여러명이 사용중인 문서의 경우 그 문서에 누가 보고 있는지 누가 어느 저점을 클릭하여 수정중인지(ex: 구글 시트같은 시스템)을 응용할 생각
...
3. 다국어 지원
   - 기본적으로 한국어, 영어, 일본어를 기본적으로 지원하게 할 생각
...
6. 다른 서비스들 장점 가저오기
   ...
   - [craft](https://www.craft.do/)에서 보이는 장점 및 단점을 확인하여 여기서 부족한 내용 보충과 추가하기
...
노션의 사용성과 VSCode의 직관적인 인터페이스와 너무 심풀하지 않은 디자인 차용하여 사용자 친화적인 환경을 제공하는 것이 목표입니다.
...
2. **모바일 특화 기능**
   ...
   - 음성 메모 및 받아쓰기
   - 알림 및 위젯 지원
   - iOS 및 Android 내 네이티브 AI 사용 가능(Google Gemini, Apple Intelligence)
